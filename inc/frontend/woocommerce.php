...
class Martfury_WooCommerce {
	...
	*/
	...
	/**
	 * Add vendor verified icon
	 */		
			
		$is_verified = esc_attr( $author->dokan_verification_status );
		if($is_verified=="approved") {
		$verified = '<i class="fa fa-check-circle-o verification-icon" title="Verified Vendor"></i>'; }
