...
<div class="sold-by-meta">
	...
	<a href="<?php echo esc_url( dokan_get_store_url( $author_id ) ); ?>"><?php echo esc_html( $shop_name ); ?> <i class="fa fa-check-circle-o verification-icon" title="Verified Vendor"></i></a>
</div>